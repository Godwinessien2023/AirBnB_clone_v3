...
class TestFileStorage(unittest.TestCase):
    ...
    def test_get(self):
            """
            test method for obtaining an instance in db storage
            """
            storage = FileStorage()
            storage.reload()
    ...
    def test_count(self):
        """
        test meyhod for counting methods obtained from db
        """
        storage = FileStorage()
        storage.reload()
        state_data = {"name": "Cali"}
        state_instance = State(**state_data)
        storage.new(state_instance)
        city_data = {"name": "Island", "state_id": state_instance.id}
